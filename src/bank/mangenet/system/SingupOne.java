...
public class SingupOne extends JFrame implements ActionListener{
	...
	addressTextField,stateTextField,cityTextField,pinTextField;
	...
	SingupOne(){
		...
		fname.setFont(new Font("Raleaway",Font.BOLD,20));
		...
		DOB.setFont(new Font("Raleaway",Font.BOLD,20));
		...
		gender.setFont(new Font("Raleaway",Font.BOLD,20));
		add(gender);
		...
		JLabel marital=new JLabel("Marital Satuts:");
